...
DEFAULTS: dict = {
    ...
    # מי שאין לו ערך אינו מופיע בעץ בכלל (לא כקופסה, לא כ"אשתו: X" ולא ברשימת ילדים) – פרטיות. חריג: מי שבלעדיו
    # צאצאים עם ערך היו מתנתקים מהעץ (אב בלי ערך של שני בנים עם ערך) מופיע כקופסה ריקה בלי שם.
    "include_unlinked": False,
    "anonymous_label": "ללא ערך",
    "min_confidence": 0.5,
