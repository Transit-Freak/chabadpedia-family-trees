...
DEFAULTS: dict = {
    ...
    # --- תבנית עץ המשפחה (הגריד, בסגנון Tree chart של ויקיפדיה) – לכיול ---
    "chart": {
        "start": "עץ משפחה/התחלה",
        "row": "עץ משפחה",
        "end": "עץ משפחה/סוף",
        # סמלי הקווים. המשמעות לוגית (ימין = התא הבא ברצף, שמאל = התא הקודם).
        "symbols": {
            "h": "-", "v": "!", "cross": "+",
            "down_right": ",", "down_left": ".", "up_right": "`", "up_left": "'",
            "t_up": "^", "t_down": "y", "t_right": ")", "t_left": "(",
            "marriage": "y",
        },
        # אם בתצוגה החיה הפינות יוצאות הפוכות (בגלל RTL) – להפוך ל-true.
